  ...
  return (
    <div className="h-742 w-full text-pretty bg-home-background bg-bottom bg-no-repeat lg:bg-cover">
      <div className="ml-10 mt-20 py-5 ">
        ...
        <p className="mb-8 text-3xl text-blue-950 sm:w-full md:w-4/12">Únete a Vineo, haz match con vinos que encajan con tus gustos gracias a nuestras recomendaciones personalizadas</p>
        <p className="text-3xl text-blue-950 sm:w-full md:w-4/12">Sorpréndete con nuevos sabores y experiencias inolvidables</p>
